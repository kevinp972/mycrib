...
const photoMetaList: ReadonlyArray<PhotoMeta> = [
  ...
  { name: 'IMG_5782', camera: 'Canon IXUS 80 IS', location: 'Amsterdam, Netherlands', alt: 'Saxophonist in Amsterdam' },
  { name: 'IMG_5783', camera: 'Canon IXUS 80 IS', location: 'Amsterdam, Netherlands', alt: 'Guitarist in Amsterdam' },
  ...
  { name: 'IMG_6344', camera: 'Canon IXUS 80 IS', location: 'New Orleans, USA', alt: 'Black Men' },
